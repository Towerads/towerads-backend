...
// STATS
import { adminStats, adminStatsProviders } from "../controllers/admin/statsController.js";
...
// CREATIVE ORDERS
router.post("/admin/creative-orders/create", requireAdmin, createCreativeOrder);
...
// PROVIDERS AVAILABILITY
router.get("/admin/providers/availability", requireAdmin, adminProvidersAvailability);
